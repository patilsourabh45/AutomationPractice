...
driver = webdriver.Firefox(executable_path=r"C:\Users\sss2327\AppData\Local\Programs\Python\Python39\geckodriver.exe")
...
driver.back()
time.sleep(5)        ## it iwll stop script execution for 5 sec
